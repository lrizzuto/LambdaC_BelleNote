...
Figures \cref{fig:chargedBtoD_FOMvsR2_cut}-\cref{fig:chargedBtoD_FOMvsSigProb_cut} show the FOM values at various cuts 
...
considering the momenta distributions plotted on Figure \ref{fig:chargedcorrD0_Pcms}: $p^{D^0 }_{CMS} > 1$ GeV/c$^2$ removes 
