...
%\begin{table}[h]
 ...
 %   \hline
 %   Continuum modeling   &  1.61   &  0.02 \\
 %   $B_{tag}$ fit Crossfeed fraction   &  0.26 &  0.01 \\
 %   $B_{tag}$ fit Crossfeed PDF shape & 0.45 &  0.01  \\
 %   2DFit crossfeed normalization & 3.23 & 0.04 \\
 %   $M_{bc}$ peaking PDF shape & 0.80 &  0.01  \\
 %   $M_{bc}$ flat PDF shape & / &  / \\
 ...
 %   \end{tabular}%
 %   }%
 %   \caption{Systematic uncertainties in the determination of the  $\bar{B^0} \rightarrow \bar{\Lambda}_c^+ X$ branching fraction in \si{\percent}.}
 %   \label{tab:systematics:ChargedCorr}
 %   \end{table}